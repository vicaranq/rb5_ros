...
class MegaPiController:
    ...
    def carSlide(self, speed):
        ...
        time.sleep(1)
        self.setFourMotors(speed*1.5, speed*3, -speed*2, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*1.5, speed*3, -speed*2.5, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*1.5, speed*3, -speed*3, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*1.5, speed*3, -speed*2, -speed*1.5) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*1.5, speed*3, -speed*2, -speed*2) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*1.5, speed*3, -speed*2, -speed*2.5) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
