...
class MegaPiController:
    ...
    def carStraight(self, speed):
        ...
        # new calibration
        # self.setFourMotors(-speed*0.8, speed*0.9, -speed*0.8, speed*0.9) # need more power on left side or less in right side
        # self.setFourMotors(-speed*0.8, speed*0.8, -speed*0.8, speed*0.8) # need more power on left wheels
        ...
        # self.setFourMotors(-speed*0.8, speed*0.8, -speed*0.9, speed*0.9) # need more on left 

        # self.setFourMotors(-speed*0.8, speed*0.8, -speed*0.95, speed*0.9) # decently straight  

        self.setFourMotors(-speed*0.8, speed*0.87, -speed*0.8, speed*0.87)
    ...
    def carSlide(self, speed):
        ...
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*0.7, speed*2.5, -speed*0.2, -speed*0.2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*1, speed*3, -speed*0.2, -speed*0.2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*1, speed*4, -speed*0.2, -speed*0.2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*1, speed*5, -speed*0.2, -speed*0.2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*1, speed*5, -speed*0.5, -speed*0.5) # 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  

        # time.sleep(1)
        # self.setFourMotors(speed*0.2, speed*0.2, -speed*0.5, -speed*2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*0.2, speed*0.2, -speed*0.5, -speed*2.5) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*0.2, speed*0.2, -speed*0.5, -speed*3) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*0.2, speed*0.2, -speed*1, -speed*2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*0.2, speed*0.2, -speed*1.5, -speed*2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
        # time.sleep(1)
        # self.setFourMotors(speed*0.2, speed*0.2, -speed*2.0, -speed*2) 
        # time.sleep(1)
        # self.setFourMotors(0,0,0,0)  
