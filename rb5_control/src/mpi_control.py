...
class MegaPiController:
    ...
    def carSlide(self, speed):
        ...
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*2, speed*3, -speed*2, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*2, speed*4, -speed*2, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*2.5, speed*3, -speed*2, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*3.5, speed*3, -speed*2, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
        time.sleep(1)
        self.setFourMotors(speed*3.5, speed*4, -speed*2, -speed*1) 
        time.sleep(1)
        self.setFourMotors(0,0,0,0)  
