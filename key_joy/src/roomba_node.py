...
class RoombaNode:
    ...
    def move_front_no_tag(self, d):
        ...
        joy_msg.axes[X] = 0.6 if d> 0 else -0.61
    ...
    def turn_90(self, left=True):
        ...
        # time_per_rad = 2.3/ (math.pi/2)
        #time_per_rad = 2.8/ (math.pi/2)
        time_per_rad = 2.34/ (math.pi/2) 

        t_start = time.time()
        
        if left:
            joy_msg.axes[THETA] = -0.86
        else:
            time_per_rad = 1.33/ (math.pi/2)     
            joy_msg.axes[THETA] = 1.2
...
if __name__ == "__main__":
    ...
    test_points = [("F", (25,2)), ("B", (2,2)), ("R", (2,4)),\
                    ("F", (25,4)), ("B", (2,4)), ("R", (2,6)),\
                    ("F", (25,6)), ("B", (2,6)), ("R", (2,8)) 
                    ]
