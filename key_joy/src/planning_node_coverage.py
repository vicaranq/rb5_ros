...
class PlanningNode:
    def __init__(self):
        ...
        # need to change tags to an array
        self.tags = {}
    ...
    def match_tag(input_tag):
        ...
        for i in range(len(tags)):
            curr_distance = (tags[i][0]-input_tag[0])**2 + (tags[i][1]-input_tag[1])**2
    ...
    def run(self, target_position_w, tag_id, robot_pos = (0.0,0.0), angle_for_short=0):
        '''
        Args:
